...
<div class="container-fluid">
    <div class="mt-5 mb-5 row justify-content-center">
        <div class="col-12 col-lg-7 col-xl-7 materi-pembelajaran">
            ...
            <div class="bg-white in-proggres">
        ...
        <div class="container">
            ...
            <div class="mt-3 row nav-tree">
                <div class="col-12 content-pembelajaran-menu">
                    <div class="text-center bg-white pembelajaran" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <span>Konten Pembelajaran</span>
                    </div>
                    ...
                    <div class="text-center bg-white pembelajaran-bar" style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                        <p class="mt-4">Proses Pembelajaran</p>
                        <figure class="highcharts-figure">
